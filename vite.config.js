...
export default defineConfig(function (_a) {
    ...
    var localBackend = env.VITE_DEV_BACKEND || 'http://localhost:8080';
    var externalBackend = env.VITE_EXTERNAL_DEV_BACKEND || 'http://47.116.192.78:8080';
    return {
        plugins: [react()],
        resolve: {
        ...
        server: {
            ...
            proxy: {
                ...
                '/ext': {
                    ...
                    changeOrigin: true,
                    rewrite: function (p) { return p.replace(/^\/ext/, ''); },
                },
            },
        },
    };
